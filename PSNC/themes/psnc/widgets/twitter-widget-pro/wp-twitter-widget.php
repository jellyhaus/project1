		...
		?>
				<table class="form-table">
					<tr valign="top">
						...
						<td>
							<input id="twp_consumer_key" name="twp[consumer-key]" type="text" class="regular-text code" value="w3PWs7EFOnXh9DZVZftSJw" size="40" />
						</td>
					</tr>
					<tr valign="top">
						<th scope="row">
						...
						<td>
							<input id="twp_consumer_secret" name="twp[consumer-secret]" type="text" class="regular-text code" value="lzfbSDqcVPGYitKR3hUPi6PXtMg2MFSF8Sewr8q3DKk" size="40" />
						</td>
					</tr>
					<?php
					if ( empty( $this->_settings['twp']['consumer-key'] ) || empty( $this->_settings['twp']['consumer-secret'] ) ) {
